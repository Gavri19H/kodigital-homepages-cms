...
export const COMPONENT_CATALOG = {
  ...
  ButtonAnswerGroup:  { category: "question", scope: "unit", produces: "enum", props: ["internal_field","choices[{label,value,analytics_id}]","required","auto_advance"], validation: ["one selected if required"], events: ["answer_click"], tokenSlots: ["primaryButton","input"] },
  TwoButtonYesNo:     { category: "question", scope: "unit", produces: "boolean", props: ["internal_field","yesLabel","noLabel","auto_advance","default?"], validation: [], events: ["answer_click","answer_default_applied"], tokenSlots: ["primaryButton"], capabilityExample: "spec: 'Are you insured?' [Yes][No]" },
  IconCardAnswerGrid: { category: "question", scope: "unit", produces: "enum", props: ["internal_field","columns(2..5)","choices[{icon,label,description?,value,analytics_id}]","required"], validation: ["one selected if required"], events: ["answer_click"], tokenSlots: ["iconCardGrid","iconCard"], capabilityExample: "screenshot: 'What type of business?' Sole Proprietor/Partnership/LLC/C-Corp/S-Corp icon cards" },
  ImageCardAnswerGrid:{ category: "question", scope: "unit", produces: "enum", props: ["internal_field","columns","choices[{imageMediaId,label,value}]","searchable?","required"], validation: ["one selected if required"], events: ["answer_click"], tokenSlots: ["iconCardGrid","iconCard"], capabilityExample: "reference-funnel: brand-logo make/carrier grid + card-search" },
