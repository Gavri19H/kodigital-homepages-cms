  ...
  const s2 = await json<{ id: number }>(await request.post(`${LG_API}/sections`, {
    data: {
      ...
      content_json: { components: [
        ...
        { type: "NumberRangeQuestion", question_id: "q_loan", question_key: "loan_q", internal_field: "loan_amount", answer_type: "number",
          props: { min: 0, max: 100000, step: 5000, default: 0, currency_affix: true } },
