...
| PC-A13 | Conditionals on NON-answer-producing components cannot hide live (applyComponentVisibility targets [data-lg-question] only, emitted only for produces!=null; pre-existing, found in P3 review round) | P4a (runtime scope) | OPEN |
