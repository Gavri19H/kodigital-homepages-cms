...
driven as a real visitor (Playwright chromium, real UA, tenant-host resolver) at 1280/375.
...
| 8c board spot-probes | RE-PROVED — 3 funnels side-by-side; library drag adds a chip; verbatim uniqueness message; rules modal plain-language sentence + 2-action rule; no overflow at 1280/375. | 8c-three-funnels-*.png, 8c-drag-*.png, 8c-uniqueness-message.png, 8c-rules-modal-*.png |
