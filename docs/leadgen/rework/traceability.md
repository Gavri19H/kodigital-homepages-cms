...
| M-08 | §5 M8 | Phone mask: grammar validation, scaffold/digit_count/regex compile | (P2 scope) | review confirmed NO half-implementation in P1 | OPEN | Mask grammar/compile lands in P2 S2.1 per plan; P1 verified clean of partial work |
...
| R-11 | §4.3-11 | Progress bar: shared + known/default funnel pages; recomputed after switch | resolver.ts server denominator + loadDirectPageSections | routing.test R-11 + parity suites (preview==serve byte-identical) | OPEN | SERVER leg PASS (denominator = shared+funnel, parity proven); client recompute-after-switch = P2 S2.3; conductor gate 2026-07-22: tsc 0 · vitest 410f/6124t · db:reset 0001→0053 clean · verify:all exit 0 (bundle 46,008) · money-path 10f/311t · adversarial SHIP (final, delta re-verified) |
