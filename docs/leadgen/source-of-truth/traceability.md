...
| SRC-11C-D | "Theme picker per funnel name" | theme-per-funnel; two funnels render two themes | P2 | P2 pack (async) | INCONCLUSIVE(step: P2 re-drive; sweep-B seeded two funnels rendering two distinct themes live) | 11c-d-funnel-a-theme.png, 11c-d-funnel-b-theme.png (sweep-b) |
